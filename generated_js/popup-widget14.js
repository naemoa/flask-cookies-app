        ...
        // JavaScript code to inject HTML and CSS for popup-widget14
        (function() {
            var html = `<div class="popup-widget14" id="popup-widget14"> 
      <div class="card card-background card-background-mask-primary move-on-hover align-items-start">
                                                        <div class="cursor-pointer">
                                                            <div class="full-background" style="background-image: url('{{ url_for('static', filename='img/curved-images/curved6.jpg') }}')"
                                                            ></div>
                                                            <div class="card-body">
                                                                <div class="d-flex">
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget14').style.display = 'block';
        `;

        ...
        // JavaScript code to inject HTML and CSS for popup-widget5
        (function() {
            var html = `<div class="popup-widget5" id="popup-widget5"> 
     <div class="card bg-gradient-faded-success  move-on-hover align-items-start">
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget5').style.display = 'block';
        `;

        ...
        // JavaScript code to inject HTML and CSS for popup-widget6
        (function() {
            var html = `<div class="popup-widget6" id="popup-widget6"> 
  <div class="card bg-gradient-faded-info move-on-hover align-items-start">
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget6').style.display = 'block';
        `;

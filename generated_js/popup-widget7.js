        ...
        // JavaScript code to inject HTML and CSS for popup-widget7
        (function() {
            var html = `<div class="popup-widget7" id="popup-widget7"> 
     <div class="card bg-gradient-faded-warning move-on-hover align-items-start">
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget7').style.display = 'block';
        `;

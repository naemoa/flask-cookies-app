        ...
        // JavaScript code to inject HTML and CSS for popup-widget8
        (function() {
            var html = `<div class="popup-widget8" id="popup-widget8"> 
     <div class="card bg-gradient-faded-danger move-on-hover align-items-start">
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget8').style.display = 'block';
        `;

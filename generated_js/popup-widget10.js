        ...
        // JavaScript code to inject HTML and CSS for popup-widget10
        (function() {
            var html = `<div class="popup-widget10" id="popup-widget10"> 
     <div class="card bg-gradient-faded-dark  move-on-hover align-items-start">
                                         ...
                                         <div class="d-flex mt-2">
                                                                    ...
                                                                    <button class="btn bg-gradient-info w-100 px-3 mb-1 ms-2" data-class="bg-white" >Accept</button>
                                                                </div>
...
@media screen and (max-width: 600px) {
 ...
 `;
            var js = `
            document.getElementById('popup-widget10').style.display = 'block';
        `;
